...
export default function HistoriaContentComponent() {
  ...
  return (
    <div>
      ...
      <Box pt="2.5em" fontFamily="Montserrat, sans-serif">
        <Center>
          <Heading
            fontFamily="Sunflower"
            fontWeight="500"
      ...
      >
        ...
        <Flex mt="2.5em">
          <Spacer />
          <Center>
            <Image src={pratoDois} w="400px" id="prato" />
          </Center>{" "}
          <Spacer />
          <Center>
            <Image src={pratoUm} w="650px" id="prato" />
          </Center>{" "}
          <Spacer />
          <Center>
            <Image src={pratoTres} w="380px" id="prato" />
          </Center>{" "}
          <Spacer />
        </Flex>
      </Box>
